...
from .strategy import TradingStrategy, TradingDecision, Action
...
class TradingAgent:
    ...
    async def analyze_and_trade(self, symbol: str) -> Optional[Dict[str, Any]]:
        ...
        print(f"[{symbol}] Decision: {decision.action.value} "
    ...
    async def execute_trade(self, decision: TradingDecision) -> Dict[str, Any]:
        ...
        try:
            ...
            position_size_usd = self.strategy.calculate_position_size(
